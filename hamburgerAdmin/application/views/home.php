...
<body>
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php/Home/hamburgerData"><span>Lumino</span>Admin</a>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			...
			<ol class="breadcrumb">
				<li><a href="index.php/Home/hamburgerData">
	...
	<script>
			...
			if($('#hamburgerek').length > 0){
				$('#hamburgerek').DataTable();
			}
			} );
	</script>
